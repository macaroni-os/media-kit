...
SRC_URI="https://download.videolan.org/pub/videolan/vlc/3.0.23/vlc-3.0.23.tar.xz -> vlc-3.0.23.tar.xz"
LICENSE="LGPL-2.1 GPL-2"
SLOT="0/5-9"
KEYWORDS="*"
PATCHES=(
	"${FILESDIR}/vlc-2.1.0-fix-libtremor-libs.patch"
	"${FILESDIR}/vlc-2.2.8-freerdp-2.patch"
	"${FILESDIR}/vlc-3.0.6-fdk-aac-2.0.0.patch"
	"${FILESDIR}/vlc-3.0.11.1-configure_lua_version.patch"
)
DOCS=(
	AUTHORS
	THANKS
...
cpu_flags_x86_sse
"
REQUIRED_USE="chromecast? ( encode )
directx? ( ffmpeg )
fontconfig? ( truetype )
libcaca? ( X )
libtar? ( skins )
...
RDEPEND="net-dns/libidn:=
	...
	samba? ( net-fs/samba[client,-debug(-)] )
